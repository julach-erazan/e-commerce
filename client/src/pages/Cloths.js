      ...
      <div className="w-[1000px] h-[400px] flex justify-evenly items-center mb-[25px]">
        ...
        <div className="w-[350px] h-full text-[#fff] bg-[#2F3C7E] flex flex-col justify-center items-start p-[50px]">
          ...
          <h2>
            ...
            our "why". And this is our "how": casual smart menswear made from
            the finest natural materials and manufactured in the best European
            ateliers. The result is just below!
          </h2>
        </div>
      </div>
